    ...
    <div className={styles.header}>
      <div className={styles.headerContent}>
        ...
        <p className={styles.courseRate}>
          <span className={styles.rate}>4.4 ⭐⭐⭐⭐</span>
          <span className={styles.rating}>(3,201 ratings)</span>
          <span className={styles.students}> 19,442 students</span>
        </p>
        <p className={styles.creation}>
          Created by{" "}
          <span className={styles.rating}>
            Abdelfattah Hamdi , Sameh Sewiras
          </span>
        </p>
        <svg
        ...
        <span className={styles.date}> Last updated 9/2015</span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
        ...
        <span className={styles.translation}> English</span>
      </div>
    </div>
  );
}
